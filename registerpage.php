       ...
       <div class="container">
           ...
           <div class="row">
               <div class="col-md-4 col-md-offset-4">
                   ...
                   <!-- Start Sign In Form -->
                   <form id="demo" action="register.php" method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
                       <h2>Sign Up</h2>
                       ...
                       <div class="form-group">
                           ...
                           <p id="result"></p>
                           <br>
                           <button type="button" id="accountverify">Verification (by AJAX)</button>
                       </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                           <p>Already registered? <a href="loginpage.php">Sign In</a></p>
                       </div>
                       <div class="form-group">
                       ...
                       $("#accountverify").click(function() {
                           $.ajax({
                               ...
                               success: function(data) {
                                   if (data.Account) {
                                       $("#demo")[0].reset();
                                       $("#result").html('Account ' + data.Account + ' has already been registered!');
                                   } else {
